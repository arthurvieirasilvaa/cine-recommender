...
public class Main {
    public static void main(String[] args) {
        ...
        RecommendationController recommendationController = new RecommendationController(consoleMenu, inputHandler, recommendationService, userService, contentService);
